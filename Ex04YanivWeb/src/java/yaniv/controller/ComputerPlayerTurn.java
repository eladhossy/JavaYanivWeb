 ...
 *
 * @author Elad Hossy
 * when it's a computer player turn to play, the game will hold, and a button is presented to the user.
 *only  when the user peresses the button, the computer play it's turn.
 */
@WebServlet(name = "ComputerPlayerTurn", urlPatterns = {"/ComputerPlayerTurn"})
public class ComputerPlayerTurn extends HttpServlet {
